...
export const MainContent = {
  ...
  telegram_link: "https://t.me/nexochann",
  favIcon: icon,
};

export const backendConfig = {
  // base: "http://192.168.29.221:3000/api",
  // origin: "http://192.168.29.221:3000",
  ...
  // base: "https://gbtkrvkb-6010.inc1.devtunnels.ms/api",
  // origin: "https://gbtkrvkb-6010.inc1.devtunnels.ms/",
  base: "https://api.nexoinvest.org/api",
  origin: "https://api.nexoinvest.org",
  //   base: "https://api.harshit.trovix.cloud/api",
  // origin: "https://api.harshit.trovix.cloud",
};
