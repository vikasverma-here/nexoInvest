    ...
    <Section id="how-to-use">
      <div className="max-w-screen-xl mx-auto">
        <Heading
          ...
          text="Coin Invest simplifies investing with powerful, AI-enhanced financial tools built for real users."
        />
        ...
        <div className="relative">
          ...
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[66rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              <h4 className="h4 mb-4 text-5xl">Smart Investment Insights</h4>
              <p className="body-2 mb-[3rem] text-2xl">
                Discover trends, analyze risks, and track your portfolio with AI-driven tools.
              </p>
              <ul className="body-2">
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                <h4 className="h4 mb-4">AI Portfolio Assistant</h4>
                <p className="body-2 mb-[3rem] text-n-3">
                  Get smart recommendations tailored to your investment goals and risk appetite.
                </p>
              </div>
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                <h4 className="h4 mb-4">Interactive Market Analysis</h4>
                <p className="body-2 mb-[2rem] text-n-3">
                  Visualize market trends and simulate investment outcomes with our real-time engine.
                </p>
